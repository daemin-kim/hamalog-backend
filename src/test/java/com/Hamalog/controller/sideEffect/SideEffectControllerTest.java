...
//                .andExpect(jsonPath("$.recentSideEffects.length()").value(3))
//                .andExpect(jsonPath("$.recentSideEffects[0]").value("두통"))
//                .andExpect(jsonPath("$.recentSideEffects[1]").value("메스꺼움"))
//                .andExpect(jsonPath("$.recentSideEffects[2]").value("어지럼증"));
//
...
//                .param("userId", userId.toString()))
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$.recentSideEffects.length()").value(0));
//
//        verify(sideEffectService).getRecentSideEffects(userId);
//    }
//
